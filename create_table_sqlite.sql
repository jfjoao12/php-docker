...
(
    game_data_id INTEGER PRIMARY KEY,
    number_of_targets INTEGER NOT NULL DEFAULT 1,
    multiple_targets INTEGER NOT NULL, -- BOOLEAN stored as INTEGER (0 or 1)
    duration_time REAL,
    time_alive REAL,
    size INTEGER,
    target_size INTEGER
...
(
    ...
    FOREIGN KEY (game_data_id) REFERENCES game_data(game_data_id)
);
...
(
    ...
    date TEXT, -- SQLite stores DATETIME as TEXT
    FOREIGN KEY (user_id) REFERENCES users(user_id),
...
(
    ...
    user_id INTEGER NOT NULL,
    comment_date TEXT, -- DATETIME stored as TEXT
    comment TEXT,
    FOREIGN KEY (user_id) REFERENCES users(user_id),
...
(17, 'joao', 'joao@joao.com', '$2y$10$RDi4mJV42oifpniY3QkIVObohmGeuSOoMZz240UrzOv2h9Tg/sUyy', x'707269766174655c696d616765735c706670735c53637265656e73686f7420323032332d31322d3037203138323733382e706e67', 'admin');
